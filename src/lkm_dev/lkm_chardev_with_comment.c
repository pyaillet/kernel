...
#define  DEVICE_NAME "tzchar"     ///< The device will appear at /dev/tzchar using this value
#define  CLASS_NAME  "tz"         ///< The device class -- this is a character device driver

MODULE_LICENSE("GPL");            ///< The license type -- this affects available functionality
MODULE_AUTHOR("Pierre-Yves Aillet");    ///< The author -- visible when you use modinfo
MODULE_DESCRIPTION("A simple Linux char driver for the TZ 🦆");  ///< The description -- see modinfo
